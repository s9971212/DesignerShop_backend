...
public class AllInOne extends AllInOneBase {
    ...
    public String createServerOrder(CreateServerOrderObj obj) {
        ...
        log.info("createServerOrder params: " + obj);
        String result = "";
        String CheckMacValue = "";
        try {
    ...
    public String fundingReconDetail(FundingReconDetailObj fundingReconDetailObj) {
        ...
        log.info("fundingReconDetail params: " + fundingReconDetailObj);
        String result = "";
        String CheckMacValue = "";
        try {
    ...
    public String queryTrade(QueryTradeObj queryTradeObj) {
        ...
        log.info("queryTrade params: " + queryTradeObj);
        String result = "";
        String CheckMacValue = "";
        try {
    ...
    public String tradeNoAio(TradeNoAioObj tradeNoAioObj) {
        ...
        log.info("tradeNoAio params: " + tradeNoAioObj);
        String result = "";
        String CheckMacValue = "";
        try {
    ...
    public String queryCreditCardPeriodInfo(QueryCreditCardPeriodInfoObj queryCreditCardPeriodInfoObj) {
        ...
        log.info("queryCreditCardPeriodeInfo params: " + queryCreditCardPeriodInfoObj);
        String result = "";
        String CheckMacValue = "";
        try {
    ...
    public String aioCheckOut(Object obj, InvoiceObj invoice) {
        ...
        if (obj instanceof AioCheckOutALL) {
            ...
            log.info("aioCheckOutALL params: " + obj);
            ...
            log.info("aioCheckOutOneTime params: " + obj);
            ...
            log.info("aioCheckOutATM params: " + obj);
            ...
            log.info("aioCheckOutBARCODE params: " + obj);
            ...
            log.info("aioCheckOutCVS params: " + obj);
            ...
            log.info("aioCheckOutDevide params: " + obj);
            ...
            log.info("aioCheckOutPeriod params: " + obj);
            ...
            log.info("aioCheckOutWebATM params: " + obj);
        } else {
        ...
        try {
            ...
            verify.verifyParams(obj);
            if (invoice != null) {
                log.info("aioCheckOut invoice params: " + invoice);
    ...
    public Object aioCheckOutFeedback(HttpServletRequest req) {
        ...
        if (parameterNames.contains("BankCode")) {
            ...
            log.info("ATMRequest params: " + obj);
            ...
            log.info("CVSRequest params: " + obj);
            String checkMacValue = EcpayFunction.genCheckMacValue(HashKey, HashIV, obj);
